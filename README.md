# Development repository for Aoede Linux 64-bit

**Aoede Linux is an Arch Linux-based audio engineering-oriented distribution in the spirit of the Ubuntu Studio, AV Linux, and KXStudio projects.** 
